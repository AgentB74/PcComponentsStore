...
# # test
# @api_view(['GET'])
# def customer_by_email(request, email):
#     if request.method == 'GET':
#         customer = CustomUser.objects.filter(email=email)
#         serializer = CustomUserSerializer(customer, context={'request': request}, many=True)
